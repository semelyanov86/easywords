                ...
                <div class="p-6 bg-white rounded-md shadow-md">
                    ...
                    <form @submit.prevent="register">
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            <div>
                                <label class="text-gray-700" for="current_password">{{
                                    i18n.t('password.current_password')
                                }}</label>
                                <input
                                    id="current_password"
                            ...
                            <div>
                                <label class="text-gray-700" for="password">{{ i18n.t('password.password') }}</label>
                                <input
                                    id="password"
                                    class="w-full mt-2 border-gray-200 rounded-md focus:border-indigo-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500"
                                    type="password"
                            ...
                            <div>
                                <label class="text-gray-700" for="password_confirmation">{{
                                    i18n.t('password.password_confirmation')
                                }}</label>
                                <input
