<template>
    <div class="container mx-auto px-6 py-8">
        ...
        <router-link class="font-bold py-1 px-2 border rounded text-white hover:bg-blue-400 inline-flex text-white bg-yellow-500 border-0 py-3 px-6 focus:outline-none hover:bg-indigo-600 rounded mt-3" :to="{name: 'Statistics'}">{{ i18n.t('statistics.go_back') }}</router-link>
    </div>
</template>
...
export default defineComponent({
    ...
    setup() {
        ...
        function receiveWords() {
            loading.value = true
            apiClient.words.knownWords().then((data) => {
