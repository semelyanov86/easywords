                ...
                <div class="p-6 bg-white rounded-md shadow-md">
                    ...
                    <form @submit.prevent="register">
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label class="text-gray-700" for="translated">{{ i18n.t('create.translated') }}</label>
                                <input
                                    id="translated"
                                    class="w-full mt-2 border-gray-200 rounded-md focus:border-indigo-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500"
                                    type="text"
                            ...
                            <div>
                                <label class="text-gray-700" for="language">{{ i18n.t('create.language') }}</label>
                                <select
                                    id="language"
                                    class="w-full mt-2 border-gray-200 rounded-md focus:border-indigo-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500"
                                ...
                                >
                                    <option
                                        :value="language"
                                        v-for="language in settings.languages_list"
                                        :key="language"
                                    >
                                        {{ language }}
                                    </option>
