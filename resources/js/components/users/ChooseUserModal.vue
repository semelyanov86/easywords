        ...
        >
            ...
            <div class="px-6 py-4 text-left modal-content">
                ...
                <div class="inline-block relative w-64 mt-3">
                        <select v-model="user" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" id="user-select">
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        return {
            closeModal, i18n, users, user, selectUser
        }
    }
})
</script>
