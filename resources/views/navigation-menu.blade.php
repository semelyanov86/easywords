        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\Word::class)
                        <x-dropdown-link href="{{ route('words.index') }}">
                        Words
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Sample::class)
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Word::class)
                <x-jet-responsive-nav-link href="{{ route('words.index') }}">
                Words
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Sample::class)
                <x-jet-responsive-nav-link href="{{ route('samples.index') }}">
                Samples
                </x-jet-responsive-nav-link>
                @endcan
